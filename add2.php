...
<body><?php
	...
	echo "<h3>Welcome to world of maths</h3>" . "$date" ?>
	<br>
		<div class="content">
			...
			for  ($i=1; $i<=5; $i++) {
					$a1 = round(rand(10000.0000,99999.0000)/1000,3);
					$a2 = round(rand(10000.0000,99999.0000)/1000,3);
					?>
					
					<?php echo "  $i.  $a1  +  $a2"; echo " = ________  </br>";		
					addition($a1, $a2);
		...
		<div class="content">
			...
			for ($s=1; $s<=5; $s++) {
					$s1 = round(rand(55555.0000,99999.0000)/1000,3);
					$s2 = round(rand(10000.0000,44999.0000)/1000,3);
					?>
					<?php echo "  "; echo "  $s.  $s1  -  $s2"; echo " = ________  </br>";		
					subtraction($s1, $s2);
